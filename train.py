...
from baseline import Simple_baseline_QAbase
from DCN import DCN_QAbase
...
def main(_):
    ...
    if FLAGS.model == "baseline":
        model = Simple_baseline_QAbase(max_q_length=65, max_c_length=780, FLAGS=FLAGS)
    elif FLAGS.model == "DCN":
        model = DCN_QAbase(max_q_length=30, max_c_length=400, FLAGS=FLAGS)
    else:
